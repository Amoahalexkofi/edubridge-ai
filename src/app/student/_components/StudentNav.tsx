...
export default function StudentNav({ userName, examTarget, avatarUrl, previewOffset, locked }: Props) {
  ...
  return (
    <>
      ...
      <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-white border-t border-[#EEEDE8] flex items-center justify-around px-2 pb-safe shadow-[0_-1px_3px_rgba(0,0,0,0.06)]" style={{ height: "64px" }}>
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${
                  active
                    ...
                    : "text-slate-500 hover:bg-[#F8F7F4] hover:text-slate-900"
                }`}
              >
